...
the "(tracked). Angular-Google-Chart Project":2.  In this post I'm going to skip some of
the basics and go straight to something advanced that I found to be in demand
for both this directive and the "(tracked). Google Charts API":3 in general.
...
"(tracked). View the example on Plunker.":4
...
[4]http://embed.plnkr.co/lOXTg5XRggwdctUedvfl/preview
