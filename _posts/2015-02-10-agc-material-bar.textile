...
p. If you're not familiar with Material Design, have you been living under a rock?!  Just kidding.  Material Design is a pretty recent initiative from Google to unify design principles across all of their public-facing technologies.  Material Design is coming in some incarnation or other to "(tracked). Android":https://developer.android.com/design/material/index.html, "(tracked). AngularJS":https://material.angularjs.org/, and even the Google Charts API.  In this article I will cover how to use the two new charts with "(tracked). Angular-Google-Chart":https://github.com/bouil/angular-google-chart.
...
p. For details on the options available for the new charts visit the API Documentation for "(tracked). Bar Charts":https://developers.google.com/chart/interactive/docs/gallery/barchart#Material and "(tracked). Line Charts":https://developers.google.com/chart/interactive/docs/gallery/linechart#Material.
