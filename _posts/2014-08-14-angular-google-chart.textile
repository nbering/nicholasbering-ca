...
p. There's no doubt about it, if you're working on a project that involves
...
p. I did a lot of digging around to find a simple solution to this problem, and
...
p. Then I found the "(tracked). Google Charts API":1.  It seemed to be the solution to all my
...
p. This last part added some considerable complexity for a new AngularJS developer.
...
h3. Enter the Directive

Then I stumbled upon the "(tracked). Angular-Google-Chart":2 directive by
"(tracked). Nicolas Bouil":3.  This simple directive takes much of the work out of the
...
support 100% of the features provided by the "(tracked). Google Charts API:1.  To be more
precise, it does not support "(tracked). Controls and Dashboards:4, as these
...
"(tracked). View the example in Plunker":5

[1]https://developers.google.com/chart/
[2]https://github.com/angular-google-chart/angular-google-chart/
